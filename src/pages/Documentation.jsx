...
const SIDEBAR_SECTIONS = [
  ...
  { id: "checkout-embed", label: "Checkout Embed", icon: Terminal },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex gap-10">
          ...
          <main className="flex-1 min-w-0">
            ...
            {/* CNT Tokens */}
            <Section id="cnt-tokens" title="Cardano Native Token Payments" icon={Package}>
              <p className="text-slate-600 mb-4">
                PayADA supports accepting any Cardano Native Token (CNT) as payment. Merchants can create payment links priced in tokens like $SNEK, $HOSKY, stablecoins (DJED, USDM, USDA), and more.
              </p>
...
res.status(200).send('OK');`} />
  ...
  -H "Authorization: Bearer YOUR_API_KEY"`} />
            ...
            {/* Checkout Embed */}
            <Section id="checkout-embed" title="Checkout Embed" icon={Terminal}>
              <p className="text-slate-600 mb-4">
                Drop a PayADA Pay Button into any HTML page without any backend code. Just include the script and add your payment link URL.
              </p>
              <CodeBlock code={`<!-- Add to your HTML -->
<script src="https://cdn.payada.io/button.js"></script>

<payada-button
  payment-link="https://payada.io/pay/your-product-slug"
  label="Pay with ADA"
  theme="indigo"
></payada-button>`} />
              <p className="text-sm text-slate-500 mt-2">The button automatically opens the PayADA checkout in a modal. Works with all Cardano browser wallets.</p>
              <h3 className="font-semibold text-slate-900 mt-6 mb-3">Pay Terminal (POS)</h3>
              <p className="text-sm text-slate-600">
                For in-person or kiosk use, the <strong>Pay Terminal</strong> feature (Dashboard → Terminals) creates a full-screen checkout
                display optimised for point-of-sale environments. Supports both one-time and subscription modes.
              </p>
            </Section>
